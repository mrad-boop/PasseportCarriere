...
const INIT_SITE_CONFIG = {
  ...
  heroTitle2: "qu'il vous faut au TCF Canada",
  heroSubtitle: "40 séries d'entraînement, scoring officiel A1→C2, correction instantanée. La plateforme utilisée par des milliers de candidats francophones.",
  ctaPrimary: "Commencer gratuitement →",
  ctaSecondary: "J'ai déjà un compte",
  // Stats hero
  stat1Val: "40",    stat1Label: "Séries",
